...
export const Skills = (props) => {
  return (
    <div className="bg-white">
      <div className="w-full mx-auto max-w-5xl px-4 py-16">
        <Subtitle title="My skills" />
        <h2 className="text-4xl md:5xl lg:text-6xl font-bold text-slate-800 mt-8 md:mt-16 leading-[150%] md:leading-[150%]">
